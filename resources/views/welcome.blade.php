...
<div class="flex">
    ...
    <div class="w-1/2 pl-4">
        <div class="bg-white rounded-xl shadow-md overflow-hidden p-8">
            <div class="uppercase tracking-wide text-sm text-indigo-500 font-semibold">Crear Usuario</div>
            <form method="POST" action="{{ route('usuarios.store') }}" class="mt-4">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nombre">Nombre</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           id="nombre" name="nombre" type="text" placeholder="Nombre" value="{{ old('nombre') }}">
